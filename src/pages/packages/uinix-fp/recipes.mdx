...
<PackageLink name="uinix-fp" />  methods are conveniently curried to support composition.
...
<PackageLink name="uinix-fp" />  methods are designed to faciliate [pointfree] notation.
