...
In this guide, we will learn more about [hyperscript], and how <PackageLink name="uinix-ui" /> leverages it to support building UI components and systems in framework-agnostic ways.
...
Please refer to **§ Frameworks** in <PackageLink name="uinix-ui" /> on how to use **uinix-ui** in the respective [hyperscript]-based libraries.
...
When using with <PackageLink name="uinix-ui" />, we assume the interface mentioned in [§ Overview](#overview).

## Conclusion

In this short guide, we covered [hyperscript] and view libraries utilizing [hyperscript].  We explored how <PackageLink name="uinix-ui" /> leverages [hyperscript] to support building UI components and systems in framework-agnostic ways.
